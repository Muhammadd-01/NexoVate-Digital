  ...
  return (
    <>
      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 bg-white dark:bg-black text-gray-900 dark:text-white py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-16 grid max-w-4xl grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-2">
              <div>
                <h3 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Contact Information</h3>
            ...
            <div className="mt-16 text-center">
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-4">Let's create something amazing together!</p>
            </div>
          </div>
        </div>
      </div>

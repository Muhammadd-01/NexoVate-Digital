    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
        ...
        <div className="flex lg:hidden">
          <button
            type="button"
            className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-nexovate-blue-500 hover:bg-nexovate-gradient hover:text-white"
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <button
            onClick={toggleTheme}
            className="rounded-full p-2 bg-white text-nexovate-blue-800 hover:bg-nexovate-gradient hover:text-white"
          >
